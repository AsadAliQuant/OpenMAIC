...
export interface Stage {
  ...
  /**
   * True when this classroom was generated by the Math Solver
   * (the MATH_SOLVER_OUTLINES prompt branch), as opposed to a regular
   * OpenMAIC course. Used to keep solver history separate from courses.
   */
  solverMode?: boolean;
}
