...
export const TTS_PROVIDERS: Record<BuiltInTTSProviderId, TTSProviderConfig> = {
  ...
  'deepgram-tts': {
    ...
    voices: [
      ...
      { id: 'aura-2-perseus-en', name: 'Perseus', language: 'en', gender: 'male' },
      { id: 'aura-2-angus-en', name: 'Angus', language: 'en', gender: 'male' },
      { id: 'aura-2-orpheus-en', name: 'Orpheus', language: 'en', gender: 'male' },
      { id: 'aura-2-helios-en', name: 'Helios', language: 'en', gender: 'male' },
      { id: 'aura-2-zeus-en', name: 'Zeus', language: 'en', gender: 'male' },
    ],
    supportedFormats: ['mp3', 'wav', 'linear16', 'mulaw', 'alaw'],
    speedRange: { min: 0.5, max: 2.0, default: 1.0 },
  },
